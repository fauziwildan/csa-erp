...
<div class="space-y-4">
    ...
    <div x-data="{ mode: (localStorage.getItem('whStockView') || 'grid') }"
         x-init="$watch('mode', v => localStorage.setItem('whStockView', v))"
         class="space-y-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md hover:border-indigo-200 transition group">
                    ...
                    <div class="aspect-square bg-gray-100 overflow-hidden relative">
                        {{-- Placeholder selalu ada di belakang; tertutup gambar jika berhasil dimuat --}}
